...
function getMainPage() {
    ...
    list.append((0, _productCardJs.getProductCard)("Товар_1", 300), (0, _productCardJs.getProductCard)("Товар_2", 350), (0, _productCardJs.getProductCard)("Товар_3", 400));
...
function getProductCard(text, price) {
    ...
    productLink.addEventListener("click", (event)=>{
        ...
        (0, _mainJs.router).navigate(`/product/${text}`);
    });
...
},{"./productCard.css":"8FtH3","/src/js/main.js":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8FtH3":[function() {},{}]},["fF58y"], null, "parcelRequirec65e")
